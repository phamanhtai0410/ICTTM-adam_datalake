...
## 3. Notebook example
- Open file [example_pipeline_opensanctions.ipynb](notebook%2Fexample_pipeline_opensanctions.ipynb)[operate_opensanctions.ipynb](notebook%2Foperate_opensanctions.ipynb) and running example