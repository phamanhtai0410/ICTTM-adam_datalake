...
def main():
    ...
    input_file_path = 'data/age_C_Kolkata.txt'  # File path to get url (.txt file)
    output_file_path = 'data/infor_age_C_Kolkata.json'   # File path to save data companies (.json file)
