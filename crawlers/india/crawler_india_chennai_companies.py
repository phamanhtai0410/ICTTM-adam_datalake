...
def main():
    ...
    file_path = 'data/india_chennai.txt'  # File path to save the elements
    ...
    total_pages = 5109  # Total number of pages to scrape
    url_base = f"https://www.zaubacorp.com/company-list/roc-RoC-Chennai/p-"
    page_start = 1
