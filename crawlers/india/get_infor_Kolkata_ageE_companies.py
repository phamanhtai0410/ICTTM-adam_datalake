...
def main():
    ...
    input_file_path = 'data/age_E_Kolkata.txt'  # File path to get url (.txt file)
    output_file_path = 'data/infor_companies_kolkata_roc_age_E.json'   # File path to save data companies (.json file)
