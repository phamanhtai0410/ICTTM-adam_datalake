...
def main():
    ...
    file_path = 'data/india_ernakulam.txt'  # File path to save the elements
    ...
    total_pages = 2857  # Total number of pages to scrape
    page_start = 1
    url = f"https://www.zaubacorp.com/company-list/roc-RoC-Ernakulam/p-"
