...
def main():
    ...
    input_file_path = 'url/india_mumbai_roc_ageD.txt'  # File path to get url (.txt file)
    output_file_path = 'url/infor_companies_mumbai_roc_age_D.json'  # File path to save url companies (.json file)
