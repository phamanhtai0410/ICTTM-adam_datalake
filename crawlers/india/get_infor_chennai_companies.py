...
def main():
    ...
    input_file_path = 'url/sample.txt'  # File path to get url (.txt file)
    output_file_path = 'url/infor_companies_Ahmedabad.json'  # File path to save url companies (.json file)
