...
from crawlers.india.engine import proxies_list
from crawlers.india.engine.print_helper import print_progress


def crawler_engine(file_path, total_pages, max_retries_per_page, scraper, sleep_duration_on_success, url, page):
    start_time = time.time()  # Record the start time
    shuffled_proxies_list = proxies_list.copy()
