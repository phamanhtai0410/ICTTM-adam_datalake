...
def main():
    ...
    input_file_path = 'url/page_india_delhi_roc_ageF.txt'  # File path to get url (.txt file)
    output_file_path = 'data_master/infor_companies_Delhi_ageF.json'   # File path to save url companies (.json file)
