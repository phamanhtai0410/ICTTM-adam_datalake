...
def main():
    ...
    input_file_path = 'data/age_B_Kolkata.txt'  # File path to get url (.txt file)
    output_file_path = 'data/infor_age_B_Kolkata.json'   # File path to save data companies (.json file)
