...
def main():
    ...
    input_file_path = 'url/age_B_Kolkata.txt'  # File path to get url (.txt file)
    output_file_path = 'url/infor_age_B_Kolkata.json'  # File path to save url companies (.json file)
