...
def main():
    ...
    input_file_path = 'data/page_india_delhi_roc_ageA.txt'  # File path to get url (.txt file)
    output_file_path = 'data_master/infor_companies_Delhi_ageA.json'   # File path to save data companies (.json file)
