...
def main():
    ...
    input_file_path = 'url/india_mumbai_roc_ageA.txt'  # File path to get url (.txt file)
    output_file_path = 'url/infor_companies_mumbai_roc_age_A.json'  # File path to save url companies (.json file)
